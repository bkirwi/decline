...
class Command[+A] private[decline](
  ...
  def parse(args: Seq[String], env: Map[String, String]): Either[Help, A] = Parser(this)(args.toList, env)
...
object Opts {
  ...
  private[decline] case class EnvVar(varName: String) extends Opts[String]
